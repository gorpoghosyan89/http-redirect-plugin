...
[zip via Github](https://github.com/gorpoghosyan89/http-redirect-plugin.git) and upload it using the WP
plugin uploader.
...
#### Translation
Safe Redirect Manager has a [.pot file](https://github.com/gorpoghosyan89/http-redirect-plugin.pot)
...
#### Issues
If you identify any errors or have an idea for improving the plugin, please do pull request
